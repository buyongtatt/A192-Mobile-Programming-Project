...
class _CartScreenState extends State<CartScreen> {
                ...
                return Card(
                  child: ListTile(
                      ...
                      leading: new CachedNetworkImage(
                        fit: BoxFit.fill,
                        imageUrl:
                            "http://lintatt.com/furniture/productimage/${cartData[index]['id']}.jpg",
  ...
  _updateCart(int index, String op) {
    ...
    String urlLoadJobs = "https://lintatt.com/furniture/php/update_cart.php";
    http.post(urlLoadJobs, body: {
      "email": widget.user.email,
      ...
      builder: (context) => new AlertDialog(
        ...
        actions: <Widget>[
          MaterialButton(
              onPressed: () {
                Navigator.of(context).pop(false);
                http.post("https://lintatt.com/furniture/php/delete_cart.php",
                    body: {
                      "email": widget.user.email,
                      "prodid": cartData[index]['id'],
                    }).then((res) {
