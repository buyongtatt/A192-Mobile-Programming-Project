...
import 'package:furniture/orderdetailscreen.dart';
...
class _PaymentHistoryScreenState extends State<PaymentHistoryScreen> {
                          ...
                          children: <Widget>[
                            ...
                            Flexible(
                                child: MaterialButton(
                                    color: Colors.white,
                                    onPressed: () =>
                                        {_sortPaymentHistoryByDate(_paymentController.text)},
                                    elevation: 5,
                                    child: Text(
                                      "Search Payment",
  ...
  Future<void> _loadPaymentHistory() async {
    String urlLoadJobs =
        "https://lintatt.com/furniture/php/load_paymenthistory.php";
    await http
