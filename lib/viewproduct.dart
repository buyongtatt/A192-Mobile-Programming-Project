          ...
          children: <Widget>[
            ...
            new Container(
                ...
                child: GridTile(
                  child: Container(
                    ...
                    child: CachedNetworkImage(
                      fit: BoxFit.fill,
                      imageUrl:
                          "http://lintatt.com/furniture/productimage/${widget.product.id}.jpg",
                ...
                Column(children: <Widget>[
                  Text(widget.product.name,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.0),textAlign: TextAlign.center,),
                  Text("Available Quantity "+widget.product.quantity,style: TextStyle(fontWeight: FontWeight.bold),)
                ],),
                SizedBox(
                  height: 10,
                ),
