...
import 'package:furniture/storecredit.dart';
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              fit: BoxFit.cover,
                              imageUrl:
                                  "http://lintatt.com/furniture/profileimages/${widget.user.email}.jpg?",
            ...
            Expanded(
                ...
                child: ListView(
                  ...
                  MaterialButton(
                    ...
                    child: Text("CHANGE YOUR NAME",style: TextStyle(color:Colors.black),),
                  ),
                  MaterialButton(
                    color: Colors.white,
                    onPressed: changePassword,
                    child: Text("CHANGE YOUR PASSWORD",style: TextStyle(color:Colors.black),),
                  ),
                  MaterialButton(
                    color: Colors.white,
                    onPressed: changePhone,
                    child: Text("CHANGE YOUR PHONE",style: TextStyle(color:Colors.black),),
                  ),
                  MaterialButton(
                    color: Colors.white,
                    onPressed: _gotologinPage,
                    child: Text("GO LOGIN SCREEN",style: TextStyle(color:Colors.black),),
                  ),
                  MaterialButton(
                    color: Colors.white,
                  ...
                  MaterialButton(
                    ...
                    child: Text("BUY STORE CREDIT",style: TextStyle(color:Colors.black),),
                  ),
